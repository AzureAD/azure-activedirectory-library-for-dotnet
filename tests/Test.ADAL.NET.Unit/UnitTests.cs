...
namespace Test.ADAL.NET.Unit
{
    ...
    {
        private const string ComplexString =
        ...
        public void RequestParametersTest()
        {
            ...
            string expectedString = string.Format("client_id=client_id&{0}={1}&{2}={3}", AdditionalParameter,
                EncodingHelper.UrlEncode(ComplexString), AdditionalParameter2, EncodingHelper.UrlEncode(ComplexString2));
        ...
        {
            Verify.AreEqual(AuthorityType.AAD,
                Authenticator.DetectAuthorityType("https://login.windows.net/tenant/dummy/"));
            Verify.AreEqual(AuthorityType.AAD,
                Authenticator.DetectAuthorityType("https://accounts-int.somethingelse.w/dummy/"));
        ...
        public void AuthenticationParametersTest()
        {
            ...
            RunAuthenticationParametersPositive(
                "Bearer authorization_uri=\"https://login.windows.net/tenant_name/oauth2/authorize\", resource_id=de",
                "https://login.windows.net/tenant_name/oauth2/authorize", "de");
            RunAuthenticationParametersPositive("Bearer authorization_uri=\"abc\", resource_id=\"de\"", "abc", "de");
            RunAuthenticationParametersPositive(" Bearer authorization_uri=abc, resource_id=de", "abc", "de");
            RunAuthenticationParametersPositive("bearer Authorization_uri=abc, resource_ID=de", "abc", "de");
            RunAuthenticationParametersPositive(
                "Bearer authorization_uri=abc, extra=\"abcd\" , resource_id=\"de=x,y\",extra2=\"fgh+s\"", "abc",
                "de=x,y");
        ...
        public void ParseKeyValueListTest()
        {
            ...
            RunParseKeyValueList(" abc  =   \" x=u\" ,   de= \"yz,t  \" ", 2, new[] {"abc", "de"}, new[] {"x=u", "yz,t"});
            RunParseKeyValueList(" abc  =\t   \" x=u\" ,   de= \"yz,t  \"\t ", 2, new[] {"abc", "de"},
                new[] {"x=u", "yz,t"});
            RunParseKeyValueList(" abc  =\t   \" x=u\" ,   de= \"yz,t  \t\"\t ", 2, new[] {"abc", "de"},
                new[] {"x=u", "yz,t"});
        ...
        [TestMethod]
        [Description("Test for ProfileInfoRawString Parsing")]
        [TestCategory("AdalDotNetUnit")]
        public void ProfileInfoParsingPasswordClaimsTest()
        {
            TokenResponse tr = CreateTokenResponse();
            tr.ProfileInfoString =
                "";
            AuthenticationResultEx result = tr.GetResults()[0];
        }

        [TestMethod]
        [Description("Test for ProfileInfoRawString Parsing")]
        [TestCategory("AdalDotNetUnit")]
        public void ProfileInfoParsingNoPasswordClaimsTest()
        {
            TokenResponse tr = CreateTokenResponse();
            tr.ProfileInfoString =
                "";
            AuthenticationResultEx result = tr.GetResults()[0];
        }
        ...
        public async Task TimeoutTest()
        {
            ...
            {
                HttpClientWrapper webClient = new HttpClientWrapper(TestServiceUrl + "?delay=0&response_code=200", null)
                {
                    TimeoutInMilliSeconds = 10000
                };
                await webClient.GetResponseAsync();

                webClient = new HttpClientWrapper(TestServiceUrl + "?delay=0&response_code=200", null)
                {
                    TimeoutInMilliSeconds = 10000
                };
                await webClient.GetResponseAsync();
                ...
                try
                {
                    webClient = new HttpClientWrapper(TestServiceUrl + "?delay=0&response_code=400", null)
                    {
                        TimeoutInMilliSeconds = 10000
                    };
                    await webClient.GetResponseAsync();
                ...
                try
                {
                    webClient = new HttpClientWrapper(TestServiceUrl + "?delay=10000&response_code=200", null)
                    {
        ...
        private static void RunParseKeyValueList(string input, int expectedCount, string[] keys = null,
            string[] values = null, bool urlDecode = false)
        {
        ...
        private static void RunSplitWithQuotes(string input, int expectedCount, string first = null,
            string second = null)
        {
