...
/*                case StsType.ADFS:
    ...
    class AadSts : Sts
    {
        public AadSts()
        {
            ...
            this.ValidNonExistingRedirectUri = new Uri("http://nonexisting.com");
            ...
            this.ValidRedirectUriForConfidentialClient = new Uri("https://confidential.com");
            this.ValidPassword = "<REPLACE1>";
            this.ValidPassword2 = "<REPLACE2>";
            this.ValidPassword3 = "<REPLACE3>";
