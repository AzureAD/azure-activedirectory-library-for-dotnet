...
namespace Microsoft.IdentityModel.Clients.ActiveDirectory
{
    ...
    public class AdalException : Exception
    {
        ...
        /// ">The exception that is the cause of the current exception, or a null reference if no inner exception is specified. It may especially contain the actual error message returned by the service.</param>
